          ...
          <ul class="nav navbar-nav side-nav">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                ...
                <li><a href="{{asset('admin/chung_loais')}}"><i class="fa fa-hand-o-right"></i> Chủng Loại Sản Phẩm</a></li>
